...
<h3 align="left">AI Engineer • Full-Stack Developer • Software Engineer</h3>
...
* 🔹 AI engineering and intelligent application development
* 🔹 Large language models, prompt engineering, RAG, and AI agents
* 🔹 AI workflow automation and multi-step agent systems
* 🔹 Python, FastAPI, Pydantic, LangChain, CrewAI, and Hugging Face
* 🔹 Embeddings, semantic search, vector databases, and knowledge retrieval
* 🔹 Integrating AI capabilities into web and mobile applications
* 🔹 Production-ready AI APIs, backend services, and data pipelines
* 🔹 Next.js, React, TypeScript, Node.js, and PostgreSQL
* 🔹 Cloud deployment, Docker, CI/CD, monitoring, and scalable architecture
* 🔹 Product quality, performance, security, UI/UX, and clean architecture
...
* 📱 **Notoo — AI Note Taker & Summary**
  An AI-powered iOS application that records, transcribes, organizes, and summarizes notes.
  https://apps.apple.com/us/app/notoo-ai-note-taker-summary/id6767136519

* 🎬 **Cliporah — AI Video Clipping Platform**
...
* 📩 Email: [felixjunang@gmail.com](mailto:felixjunang@gmail.com)
* 🌐 Portfolio: https://felixangcotjr.com

---

<p align="center">
  ⭐️ <i>Building intelligent products that turn AI capabilities into real-world solutions.</i>
</p>
